...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project::ProjectCursor::decl(),
        db::models::project::ProjectPage::decl(),
        ...
        db::models::arena_group::ArenaCandidatePurpose::decl(),
        db::models::arena_group::ArenaCandidate::decl(),
        db::models::task::TaskExecutionKind::decl(),
        db::models::task::TaskStatus::decl(),
        db::models::task::TaskOpenTarget::decl(),
        db::models::task::Task::decl(),
        db::models::task::TaskSummary::decl(),
        db::models::task::TaskCursor::decl(),
        db::models::task::TaskSummaryPage::decl(),
        db::models::session::SessionListItem::decl(),
        db::models::session::SessionCursor::decl(),
        db::models::session::SessionPage::decl(),
        server::routes::execution_data::ExecutionDataOwner::decl(),
        server::routes::execution_data::ExecutionDataCapabilities::decl(),
        ...
        server::routes::sessions::NativeSessionDiscoveryState::decl(),
        ...
        db::models::requests::SessionDeletionInfo::decl(),
        db::models::requests::SessionDeletionResult::decl(),
        server::routes::git_import::types::GitAuthMode::decl(),
        server::routes::git_import::types::GitConnection::decl(),
        server::routes::git_import::types::WriteGitConnection::decl(),
        server::routes::git_import::types::InspectGitRemote::decl(),
        server::routes::git_import::types::GitRemoteInspection::decl(),
        server::routes::git_import::types::StartGitImport::decl(),
        server::routes::git_import::types::GitImportState::decl(),
        server::routes::git_import::types::GitImportJob::decl(),
        ...
        executors::agent_settings::ConfigProfileView::decl(),
        executors::agent_settings::SaveConfigProfileRequest::decl(),
        executors::agent_settings::UpdateConfigProfileRequest::decl(),
        ...
        executors::agent_tools::SensitiveStringWrite::decl(),
        executors::agent_tools::SensitiveStringListWrite::decl(),
        executors::agent_tools::SensitiveStringMapWrite::decl(),
        executors::agent_tools::McpServerWriteDefinition::decl(),
        executors::agent_tools::SkillWriteDefinition::decl(),
        executors::agent_tools::AgentToolWriteDefinition::decl(),
        executors::agent_tools::McpServerDefinitionSummary::decl(),
        executors::agent_tools::SkillDefinitionSummary::decl(),
        executors::agent_tools::AgentToolDefinitionSummary::decl(),
        executors::agent_tools::AgentToolView::decl(),
        executors::agent_tools::AgentToolProviderInventoryView::decl(),
        executors::agent_tools::AgentToolInventoryView::decl(),
        ...
        executors::agent_commands::AgentCommandProvider::decl(),
        executors::agent_commands::AgentCommandScope::decl(),
        executors::agent_commands::AgentCommandState::decl(),
        executors::agent_commands::AgentCommandFormat::decl(),
        executors::agent_commands::AgentCommandCapabilities::decl(),
        executors::agent_commands::AgentCommandProviderCapabilities::decl(),
        executors::agent_commands::AgentCommandDefinitionView::decl(),
        executors::agent_commands::AgentCommandView::decl(),
        executors::agent_commands::AgentCommandProviderError::decl(),
        executors::agent_commands::AgentCommandProviderInventoryView::decl(),
        executors::agent_commands::AgentCommandInventoryView::decl(),
        executors::agent_commands::AgentCommandLocator::decl(),
        executors::agent_commands::CommandTextWrite::decl(),
        executors::agent_commands::OptionalCommandTextWrite::decl(),
        executors::agent_commands::AgentCommandWriteDefinition::decl(),
        executors::agent_commands::CreateAgentCommandRequest::decl(),
        executors::agent_commands::UpdateAgentCommandRequest::decl(),
        executors::agent_commands::RemoveAgentCommandRequest::decl(),
        executors::agent_commands::ToggleAgentCommandRequest::decl(),
        executors::agent_commands::AgentCommandErrorCode::decl(),
        executors::agent_commands::AgentCommandOperationError::decl(),
        server::routes::agent_commands::AgentCommandDiscoveryQuery::decl(),
